...
export const asyncRoutes: AppRouteRecord[] = [
  {
    ...
    children: [
      ...
      page('alerts', 'OverviewAlerts', '告警中心', ['overview:read']),
  ...
  },
  {
    ...
    children: [
      ...
      page('firewall', 'PolicyFirewall', 'nftables', ['policy:firewall:read']),
  ...
  },
  {
    ...
    children: [
      ...
      page('diagnostics', 'MaintenanceDiagnostics', '诊断工具', ['maintenance:diagnostics:read']),
